...
def main():
    ...
    #In the record with SRC_ID 77683  change FlowAmont by substarcting amont in record 77681 
    #Add column CombinedFlowLookup to output  and concatinate 
