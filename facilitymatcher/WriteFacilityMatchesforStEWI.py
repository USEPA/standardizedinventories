...
from facilitymatcher.globals import stewi_inventories,filter_bridges_by_program_list,filter_bridges_by_inventory_list,download_extract_FRS_combined_national
...
stewi_bridges = filter_bridges_by_inventory_list(FRS_Bridges,stewi_inventories)

#Separate out eGRID and EIA-860 matches to identify EIA matches to add to eGRID set
eia_bridges = filter_bridges_by_program_list(FRS_Bridges,['EIA-860'])
egrid_bridges = filter_bridges_by_program_list(FRS_Bridges,['EGRID'])
