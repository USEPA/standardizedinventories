...
BR2015['ReliabilityScore'] = float(rcrainfo_reliability_table['DQI Reliability Score'])
...
#Export to csv
BR2015.to_csv(output_dir + 'RCRAInfo_2015.csv',index=False)
